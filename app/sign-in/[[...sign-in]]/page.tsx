...
import { AUTH_PAGE_FEATURES } from "@/lib/constants"

export default function SignInPage() {
  return (
    <div className="flex flex-col md:flex-row min-h-dvh">
      <div className="w-full md:w-1/2 flex flex-col justify-center px-16 py-12 bg-elevated">
