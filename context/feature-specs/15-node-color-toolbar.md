...
2. Add a toolbar above selected nodes.
    ...
    - active swatches should fell clearly selected
...
4. Selected nodes should visually reflect their active color pairs

    The node background updates to the selected color, and the text automatically updates to it's paired text color.

## Scope Limits

- don't change drap/drop behavior
