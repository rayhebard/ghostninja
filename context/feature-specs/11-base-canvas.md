...
4. Add shared canvas types into `types/canvas.ts`.
    ...
    Also define the custome node and edge types:
    - `canvasNode`
    - `canvasEdge`
...
- Shared canvase types exist in `types/canvas.ts`.
