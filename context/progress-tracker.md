...
- Project dialogs — Create, rename, delete dialogs with editor home screen

## Current Goal

- Build editor home screen and project dialogs with mock data (no API/persistence)
...
- Project dialogs use mock data only — no API calls or persistence yet.
